...
public class Letter implements CharSequence {
    ...
    private static Set<String> shamsi = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("ت", "ث", "د", "ذ", "ر", "ز", "س", "ش", "ص", "ض", "ط", "ظ", "ن", "ل")));
    private static Set<String> vowels = Collections.unmodifiableSet(new HashSet<>(Arrays.asList("َ","ُ","ِ","ً","ٍ","ٌ","ا","و","ي")));;
}
